...
s({trig = "env", name = "Generic environment"},
    {
		t("\\begin{"), i(1,"env"), t("}"),
		t({"",""}), t("    "), d(2,get_visual),
		t({"",""}), t("\\end{"), rep(1), t("}")
...
s({trig = "bmat", name = "New bmatrix", snippetType = "autosnippet"},
    {
        t("\\begin{bmatrix}"),
...
s({trig = "sbq", name = "Subset eq", snippetType = "autosnippet"},
    {
		f(function(_,snip) return snip.captures[1] end),
        t("\\subseteq")
    },
...
s({trig = "rar", name = "Right arrow", snippetType = "autosnippet"},
    {
		f(function(_,snip) return snip.captures[1] end),
        t("\\rightarrow")
    },
...
s({trig = "lar", name = "Left arrow", snippetType = "autosnippet"},
    {
		f(function(_,snip) return snip.captures[1] end),
        t("\\leftarrow")
    },
